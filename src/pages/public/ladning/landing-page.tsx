...
const reviewList3 = [
  {
    description:
      '"코딩은 덤이고 무엇보다 선생님이 애기와 잘 놀아주셔서 까탈스럽지않게 교육받을수있었네요 그동안 친근하게 잘 놀아주셔서 감사했어요 호호"',
    name: '- 중등부 2학년 이OO 어머님',
  },
  {
    description:
      '"선생님이 제 아이수준에 맞추어 커리큘럼을 조정해주셔서 부담 없이 맡길 수 있었습니다. 어려웠던 코딩이 이제는 재미있다고 하네요. 감사해요"',
  ...
  {
    description:
      '"강의때 추천해준 자료들 보면서 스스로 공부하고 무언가를 찾아보네요. 무엇보다 혼자서 해보려고 하는 습관을 생기게 해줘서 정말 감사하네요."',
